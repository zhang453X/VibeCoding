...
如果当前 GitHub 仓库是公开仓库，那么仓库里的单个 `README.md` 文件不能单独设置成“仅自己可见”。

你可以选择以下方式之一：

- 将整个仓库改为私有仓库
- 把敏感说明写在本地文档中，不提交到 GitHub
- 使用单独的私有仓库保存私人说明
- 使用 GitHub 私有 Gist 或其他私有笔记工具保存敏感内容

因此：

- 这个仓库里的 README 适合写公开的使用说明
- SSH 私钥、账号口令、访问令牌等敏感信息不应写入仓库
